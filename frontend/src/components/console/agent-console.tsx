...
export function AgentConsole() {
  ...
  const [modelFormat] = useState('structuremodel-v1')
                ...
                <div>
                  ...
                  <ol className="timeline-list">
                    {result.toolCalls.map((call, idx) => (
                      <li key={`${call.tool}-${idx}`} className={`timeline-item ${call.status === 'error' ? 'error' : 'ok'}`}>
                        ...
                        <div className="timeline-content">
                          ...
                          <p>status: {call.status}{call.errorCode ? ` | errorCode: ${call.errorCode}` : ''}</p>
                        </div>
                      </li>
                    ))}
                  </ol>
